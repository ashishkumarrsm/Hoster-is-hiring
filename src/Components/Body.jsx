  ...
  return (
    <div className="-space-y-4 lg:flex">
        ...
        <div className='space-y-4 lg:flex-1 lg:order-1'>
            <h1 className='text-5xl font-bold font-playfair leading-tight  lg:text-7xl'>Host your website in less than 5 minutes</h1>
            ...
            <div className='flex gap-2'>
                <img src="/assets/Checkmark.svg" alt=" Chack" className=""/>
